		...
		<div class="card-body">
			<form action="" id="manage_evaluation">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="task_id" id="task_id" class="form-control form-control-sm" required>
								<option value="" disabled="" selected="">Por Favor Seleccione el Empleado Primero.</option>
							</select>
						</div>
						<div class="row " id="ratings-field" style="display: none">
							<div class="col-md-12">
							<label for="" class="control-label">CALIFICAR:</label>
							</div>
							<hr>
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Eficiencia de los Empleados:</label>
								...
								<div class="form-group">
									<label for="" class="control-label">Tiempo de la Actividad:</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Calidad del Trabajo:</label>
								...
								<div class="form-group">
									<label for="" class="control-label">Precisión del Trabajo:</label>
					...
					<div class="col-md-6">
						<div id="post-field">
							<div><center><i>Selecciona una Actividad Primero</i></center></div>
						</div>
					</div>
				</div>
				<hr>
...
<script>
	...
	function update_emp(){
		...
		$.ajax({
			...
			complete:function(){
				$('#task_id').select2({
					placeholder:'Por Favor Selecciona una Tarea',
					width:'100%'
				})
				task_update()
				end_load();
