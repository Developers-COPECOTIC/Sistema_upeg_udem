	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_department" href="javascript:void(0)"><i class="fa fa-plus"></i> Agregar Nueva Direccion</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	_conf("¿Estás Seguro de Eliminar esta Direccion?","delete_department",[$(this).attr('data-id')])
	})
	})
