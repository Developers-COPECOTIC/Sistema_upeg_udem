...
<div class="container-fluid">
	<form action="" id="manage-department">
		...
		<div class="form-group">
			<label for="department" class="control-label">Nombre de la Direccion:</label>
		...
		$('#manage-department').submit(function(e){
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						alert_toast("Datos Guardados Correctamente.","Exitoso");
						setTimeout(function(){
							location.reload()	
						},1750)
					}else if(resp == 2){
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> La Direccion ya Existe.</div>')
						end_load()
					}
				}
			})
