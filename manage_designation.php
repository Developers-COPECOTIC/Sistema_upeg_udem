...
<div class="container-fluid">
	<form action="" id="manage-designation">
		...
		<div class="form-group">
			<label for="designation" class="control-label">Nombre del Cargo:</label>
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						...
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> El Cargo ya Existe.</div>')
						end_load()
					}
				}
			})
